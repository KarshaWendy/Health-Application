...
class HospitalAppointmentForm extends StatefulWidget {
  @override
  _HospitalAppointmentFormState createState() => _HospitalAppointmentFormState();
}

class _HospitalAppointmentFormState extends State<HospitalAppointmentForm> {
      ...
      child: Form(
          ...
          child: Column(
            ...
            children: [
              Row(children: [
                Padding(
                padding: const EdgeInsets.fromLTRB(5, 35, 10, 10),
                child: InkWell(
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text('The Nairobi Hospital',
                      style: TextStyle(
                          fontSize: 20,
