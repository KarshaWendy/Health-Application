// ignore_for_file: prefer_const_constructors, file_names, use_key_in_widget_constructors, prefer_final_fields, unused_field, import_of_legacy_library_into_null_safe
...
3.3 Scope: The Mobile Application, the Services and any Reclamations are for 
...
5.4.4 to send or receive any material which is technically harmful (including 
...
7.1 We will use reasonable endeavours to correct any errors or omissions as soon 
...
8.5 Our rights under this Clause 8 shall not prejudice any other right or remedy 
...
9.8 Notwithstanding our efforts to ensure that our system is secure, you 
 ...
 """;
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
          appBar: AppBar(
            centerTitle: true,
              title: Text("Smart Mobile App Privacy Policy",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              backgroundColor: Color.fromARGB(255, 55, 150, 142),
          ),
          body: Markdown(
               data:mdString,
               ...
               styleSheet: MarkdownStyleSheet(
                 h1: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold,color: Color.fromARGB(255, 37, 70, 69)),
                  h2: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700,color: Color.fromARGB(255, 13, 136, 126)),
                  h3: const TextStyle(fontSize: 15, fontWeight: FontWeight.w400,color: Color.fromARGB(255, 4, 167, 126))
