...
import 'package:online_community_mobile_app/Components/Insurance/SubComponents/OutpatientDetails.dart';


class OutpatientCard extends StatefulWidget {
  @override
  _OutpatientCardState createState() => _OutpatientCardState();
}

class _OutpatientCardState extends State<OutpatientCard> {
  @override
    ...
    return Container(
      child: Card(
        ...
        Padding(
              ...
              child: Text("Outpatient Benefits",
                  style: TextStyle(
