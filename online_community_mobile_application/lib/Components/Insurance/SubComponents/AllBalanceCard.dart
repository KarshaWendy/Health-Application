...
import 'package:online_community_mobile_app/Components/Insurance/SubComponents/AllBalance.dart';


class AllBalanceCard extends StatefulWidget {
  @override
  _AllBalanceCardState createState() => _AllBalanceCardState();
}

class _AllBalanceCardState extends State<AllBalanceCard> {
  @override
    ...
    return Container(
      child: Card(
        child: Column(
          children: [
         Padding(
              padding: const EdgeInsets.fromLTRB(2, 20, 200, 5),
