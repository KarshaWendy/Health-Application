...
class SpouseDetails extends StatefulWidget {
  @override
  _SpouseDetailsState createState() => _SpouseDetailsState();
}

class _SpouseDetailsState extends State<SpouseDetails> {
  @override
  Widget build(BuildContext context) {
    List<String> subject = ['Scheme:','Name:','Status:'];
    List<String> feedback = ['UAP Insurance','Kanze Durwa','Active'];
    return Padding(
