...
import 'SpouseDetails.dart';

class SpouseCard extends StatefulWidget {
  @override
  _SpouseCardState createState() => _SpouseCardState();
}

class _SpouseCardState extends State<SpouseCard> {
  @override
